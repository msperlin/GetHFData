---
title: "Downloading and aggregating high frequency trading data from Bovespa"
author: "Marcelo Perlin"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{How to use GetHFData}
...
In this example we will download files from the ftp for _PETR4_, an equity contract traded in Bovespa. The data will be processed, resulting in financial data aggregated by 15 minutes.
